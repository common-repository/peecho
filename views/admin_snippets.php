<?php
	...
	define('PLUGINURL',$pluginfoldername.'/');
...
?>
        ...
        <tr class='recent'>
            ...
            <td class='desc'>
                ...
                <textarea name="<?php echo $key; ?>_snippet" class="large-text" style='width: 100%;' rows="5" readonly="readonly"><?php echo htmlspecialchars($snippet['snippet'], ENT_NOQUOTES); ?></textarea>

                <input type="button" name="upload-btn" id="upload-btn-<?php echo $key; ?>" onclick="publicationfileupload('<?php echo $key; ?>')" class="button-secondary" value="Upload publication"><br/><br/>
...
<script type="text/javascript">
    ...
    function publicationfileupload(id){
		...
		var image = wp.media({ 
			...
			jQuery.magnificPopup.open({
				...
				items: {
					...
					src: '<?php echo  plugins_url( 'views/popup/ajax-loader.gif',Peecho::FILE); ?>'
